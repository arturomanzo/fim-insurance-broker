  ...
  return (
    <div>
      ...
      <section className="relative py-16 md:py-24 text-white overflow-hidden">
        <Image
          src="/images/brand/cityscape.jpg"
          ...
          <div className="mt-14 bg-white rounded-2xl border border-gray-100 p-8 flex flex-col md:flex-row items-center justify-between gap-6 shadow-sm">
            ...
            <div className="flex flex-wrap gap-3 flex-shrink-0">
              ...
              <a
                ...
                className="inline-flex items-center gap-2 bg-[#25D366] hover:bg-[#20c05c] text-primary font-semibold px-6 py-3 rounded-lg transition-colors"
              >
