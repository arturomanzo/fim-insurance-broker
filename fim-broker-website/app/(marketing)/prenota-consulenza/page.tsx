...
export const metadata: Metadata = {
  ...
  twitter: {
    images: ['/api/og?title=Prenota+Consulenza&tag=FIM+Insurance+Broker&sub=Consulenza+gratuita+e+senza+impegno.+In+ufficio+o+in+videochiamata.'],
  },
}
