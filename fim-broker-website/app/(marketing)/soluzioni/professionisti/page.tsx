...
const BROCHURE = {
  href: '/docs/rc-professionale-brochure.pdf',
  label: 'Brochure RC Professionale (PDF, 10 pagine)',
  desc: 'Le cinque parole da capire prima di firmare, cosa copre e cosa resta fuori, le obiezioni più comuni con la risposta, cosa serve per il preventivo. Senza premi in euro: quelli dipendono dalla tua categoria.',
}
...
const categories = [
  ...
  { name: 'Commercialisti', icon: '📊', obligation: 'Obbligatoria D.P.R. 137/2012' },
  ...
  { name: 'Consulenti del Lavoro', icon: '👥', obligation: 'Obbligatoria D.P.R. 137/2012' },
  { name: 'Psicologi', icon: '🧠', obligation: 'Obbligatoria D.P.R. 137/2012' },
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
            <div>
              ...
              <div className="flex flex-wrap gap-4">
                ...
                <a
                  ...
                  className="inline-flex items-center gap-2 bg-[#25D366] hover:bg-[#20c05c] text-primary font-semibold text-lg px-8 py-4 rounded-lg transition-colors"
                >
                ...
                <a href={BROCHURE.href} className="btn-outline-white text-lg px-8 py-4">
            ...
            <div className="relative hidden lg:block">
              <div className="relative rounded-2xl overflow-hidden aspect-[4/3] shadow-2xl">
                <Image
                  src="/images/brand/professionisti-hero.jpg"
                  alt="Protezione professionale FIM Insurance Broker"
                  fill
        ...
        <div className="container-custom">
          <div className="grid grid-cols-1 lg:grid-cols-5 gap-8 items-center">
            <div className="lg:col-span-3">
              <span className="inline-block bg-primary/10 text-primary text-sm font-semibold px-4 py-1.5 rounded-full mb-3">
                Da leggere prima del rinnovo
              </span>
              <h2 className="text-2xl md:text-3xl font-black text-primary mb-3">
                Dieci pagine per capire cosa stai firmando
              </h2>
              <p className="text-gray-600 leading-relaxed">
                Claims made, retroattività, postuma, massimale, franchigia: sono le cinque parole che decidono se una
                RC professionale vale qualcosa il giorno in cui serve. La brochure le spiega una per una, dice cosa
                copre e cosa resta fuori, e risponde alle frasi che sentiamo più spesso, a partire da
                &laquo;ce l&apos;ho già, me l&apos;ha fatta la convenzione dell&apos;Ordine&raquo;.
              </p>
            </div>
            <div className="lg:col-span-2">
              <a
                href={BROCHURE.href}
                className="flex items-start gap-4 bg-gray-50 border border-gray-200 hover:border-primary/40 rounded-xl p-5 transition-colors group"
              >
                <span className="w-12 h-12 rounded-lg bg-primary text-white flex items-center justify-center flex-shrink-0 text-xs font-black">PDF</span>
                <span>
                  <span className="block font-bold text-primary group-hover:underline">{BROCHURE.label}</span>
                  <span className="block text-sm text-gray-600 mt-1">{BROCHURE.desc}</span>
                </span>
              </a>
            </div>
          </div>
              ...
              <div className="space-y-4 mb-8">
                {[
                  ...
                  <div key={step} className="flex items-center gap-3">
                    <span className="w-7 h-7 rounded-full bg-accent-cta text-white text-xs font-black flex items-center justify-center flex-shrink-0">
                      {i + 1}
                    </span>
