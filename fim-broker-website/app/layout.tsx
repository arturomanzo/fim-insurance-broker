...
const jsonLd = {
  ...
  description:
    'Broker assicurativo indipendente con oltre 20 anni di esperienza. Soluzioni assicurative personalizzate per privati e aziende. Iscritto RUI Sez. B n. B000405449.',
  slogan: 'La tua sicurezza. Le nostre soluzioni.',
  ...
  identifier: {
    '@type': 'PropertyValue',
    name: 'Numero RUI IVASS',
    value: 'B000405449',
  },
  founder: {
    '@type': 'Person',
    name: 'Arturo Manzo',
    jobTitle: 'Broker Assicurativo',
  },
  address: {
    '@type': 'PostalAddress',
  ...
  knowsAbout: [
    ...
    'Assicurazione casa e abitazione',
    'Assicurazione salute e malattia',
    'Polizze aziendali e PMI',
    'RC professionale',
